...
const std::string calc_dm(const std::string& json_data, const char* country, const int speed_profile)
{
...
const std::string calc_dm_par(const std::string& json_data, const char* country, const int speed_profile)
{
...
const std::string calc_paths(const std::string& json_data, const char* country, const int speed_profile)
{
    rapidjson::Document d;
    LevelID earlyStopLevel = 10;
